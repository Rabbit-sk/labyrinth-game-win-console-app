    ...
    do
    {
        ...
        do
        {
            switch(Polozka)
            {
                case 1:
                    system("cls");
                    printf("X        X   XXX  X   X  XXX   X X   X XXXXX\n");
                    printf("X       X X  X  X  X X   X  X  X XX  X   X\n");
                    printf("X      XXXXX XXX    X    XXX   X X X X   X\n");
                    printf("X      X   X X  X   X    X  X  X X  XX   X\n");
                    printf("XXXXX  X   X XXX    X    X   X X X   X   X\n\n");
                    printf("XXXXXXXXXXXX\n");
                    printf("XX     XXX C          * LABYRINTY *\n");
                    printf("XX XXX X   X          NOVY LABYRINT\n");
